...
local Window = Fluent:CreateWindow({
    Title = "Saber Hub | Blox Fruits",
    SubTitle = "By ThầyDuycommunity",
    TabWidth = 260,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=16722272371"
...
spawn(function()
    ...
    if _G.FindMirageIsland then
        if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") or game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
            if HighestPointRealCFrame and (game.Players.LocalPlayer.Character.HumanoRootPart.Position - HighestPointRealCFrame.Position).Magnitude > 10 then
